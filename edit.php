...
if($_SESSION['name']){
  ...
  if(isset($_POST['update'])){    
    ...
    if($dataid == $id ){
      $udate = "UPDATE `phonebook` SET `name`= '$name',`address`='$address',`phone`='$phone' WHERE `id` = '$dataid' ";
    //   print_r($_POST);
    //   echo $udate; 
          ...
          <div class="col-md-6 bg-light p-5">
            ...
            <input type="hidden" name="id" id="id" value="<?php echo $data['id']; ?>">
              ...
              <div class="form-group">
                ...
                <textarea name="address" id="address" cols="3" class="form-control" placeholder="Enter Your Address" ><?php echo $data['address']; ?></textarea>    
              </div>
